...
Students should upload their solutions to Github. When ready for evaluation they should push their code to the FEWD-Homework repository. Bonus materials are completely optional.
